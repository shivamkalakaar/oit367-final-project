...
This project partners with Ethisphere Institute to evaluate whether companies on their World's Most Ethical Companies (WMEC) list exhibit superior risk-adjusted stock market performance relative to a broad market benchmark. We analyze 5 years of daily price data (Jan 2021 – Dec 2025) for 113 publicly traded WMEC honorees across five analyses: downside resilience, consistency, upside/downside capture, tail-risk behavior, and cross-sectional segmentation.

**Key finding:** Honorees provide statistically significant downside protection in the worst market months (+1.39 pp excess return, 59.3% hit rate), but show no consistent alpha in normal conditions.
...
│   └── fig0–fig5c (*.png)         # All figures used in the report
│
...
3. Run all cells. Outputs (CSVs and figures) are saved to `Model/output/`.
